            ...
            {["posts", "media", "likes"].map((tab) => {
              return (
                <button
                  ...
                  className={`flex-1 px-4 py-2 transition-colors text-sm font-medium cursor-pointer rounded-lg ${activeTab === tab ? `bg-indigo-600 text-white` : `text-gray-600 hover:text-gray-900`}`}
                >
                      ...
                      {post.image_urls.map((image, ind) => (
                        ...
                        >
                          <img
                            ...
                            key={ind}
                            alt=""
                            className="w-64 aspect-video object-cover rounded-xl"
                          />
