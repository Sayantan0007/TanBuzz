      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-2">
            Share your thougts with the world
          </p>
        </div>
        {/* Form */}
        <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-2xl shadow-2xl space-y-4">
          ...
          <textarea
            name=""
            id=""
            className="w-full resize-none placeholder-gray-400 outline-none text-sm mt-4 max-h-20"
              ...
              {images.map((img, i) => {
                return (
                  <div key={i} className="relative group">
                    ...
                    <div
                      onClick={() =>
                        setImage(images.filter((_, index) => index !== i))
                      }
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-300">
            ...
            <input
              ...
              hidden
              multiple
              onChange={(e) => setImage([...images, ...e.target.files])}
            />
